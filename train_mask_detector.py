...
plot_path = os.getcwd()+"//plot_mobilenet"
...
print("[INFO] loading images train...")
...
print("-------------------------")
print("[INFO] loading images test...")
...
tfjs.converters.save_keras_model(model, './web_demo/static/models_mobilenet')
